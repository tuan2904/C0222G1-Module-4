package com.example.product_plus.repository;
...
public interface IProductRepository extends JpaRepository<Product, Integer> {
    ...
    void editProduct(@Param("id_product") int id, @Param("name_product") String name,
                     @Param("price_product") String price, @Param("describe_product") String describe, @Param("producer_product") String producer);
}
