...
import com.example.blogupdate.repository.AppUserRepository;
import com.example.blogupdate.repository.UserRoleRepository;
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        if (userRoles != null) {
            for (UserRole userRole : userRoles) {
                // ROLE_USER, ROLE_ADMIN,..
                        GrantedAuthority authority = new SimpleGrantedAuthority(userRole.getAppRole().getUserName());
